...
#SBATCH --output=logs/dinov3_encoding_%j.out
#SBATCH --error=logs/dinov3_encoding_%j.err
#SBATCH --time=2:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Run the encoding script with DINOv3
python strap/embedding/encode_datasets.py --encoder dinov3 
