#!/bin/bash
#SBATCH --job-name=dinov2_retrieval
#SBATCH --output=logs/dinov2_retrieval_%j.out
#SBATCH --error=logs/dinov2_retrieval_%j.err
...
# Run the retrieval script with DINOv2
python strap/retrieval/retrieval.py --model dinov2
